...
class Field extends BaseField
{
    ...
    protected static $css = [
        '@extension/oskoala/form-media/field.css'
    ];

    protected static $js = [
        '@extension/oskoala/form-media/jquery.dragsort.js',
        '@extension/oskoala/form-media/field.js'
    ];
    ...
    public function render()
    {
        ...
        $this->addVariables([
            'options' => [
                ...
                'delete_url' => admin_route("admin.lake-form-media.delete"),
            ],
        ]);
