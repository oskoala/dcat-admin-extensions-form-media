<div
    class="lake-form-media lake-form-media-{{ str_replace(['[', ']'], ['-', ''], $name) }} {{$viewClass['form-group']}} {!! !$errors->has($errorKey) ? '' : 'has-error' !!}"
...
>
    ...
    <div id="LakeFormMediaModel{{ str_replace(['[', ']'], ['-', ''], $name) }}Body">
        <div class="modal fade lake-form-media-modal"
             tabindex="-1"
             role="dialog"
                ...
                <div class="modal-content" style="width: 100%">
                    <div class="modal-header">
                        <h4 class="modal-title"
                            id="LakeFormMediaModalLabel">{{ LakeFormMedia::trans('form-media.check_image') }}</h4>
                        <button type="button"
                                class="close lake-form-media-close"
                    ...
                    <div class="mailbox-controls with-border lake-form-media-actions-label" style="margin-left: 10px;">
                        ...
                        <button type="button" class="btn btn-primary lake-form-media-delete-button">
                            <i class="fa fa-remove"></i>&nbsp;&nbsp;{{ LakeFormMedia::trans('form-media.delete') }}
                        </button>
                    ...
                    <div class="modal-body pre-scrollable">
                        <!-- 页面导航 -->
                        <ol class="breadcrumb lake-form-media-nav-ol" data-current-path="/"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default lake-form-media-close"
                                data-modal="LakeFormMediaModel{{ str_replace(['[', ']'], ['-', ''], $name) }}">{{ LakeFormMedia::trans('form-media.close') }}</button>
                        <button type="button"
                                class="btn btn-primary lake-form-media-submit">{{ LakeFormMedia::trans('form-media.save') }}</button>
                    </div>
                    ...
                    >
                        <button type="button"
                                class="btn btn-primary hidden lake-form-media-modal-prev-page">{{ LakeFormMedia::trans('form-media.prev') }}</button>
                        <button type="button"
                                class="btn btn-primary hidden lake-form-media-modal-next-page">{{ LakeFormMedia::trans('form-media.next') }}</button>
                    </div>
                </div>
            </div>
        </div>
